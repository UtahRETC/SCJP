public class TestPolygon {
	public static void main(String[] args) {
		...
		//Is a square a rectangle? no. If the instantiated object does not pass the test there will be
		...
		//At runtime the Square object still behaves like a square -- it runs the Square version of sayHello() not the rect one.
		//Rectangle rs = new Square(4,4);
		//The Square constructor runs:
		//So you can't pull shenanigans like this:
		//The compiler will let you get away with it because the parameter type and number match the constructor arguments
...
abstract class Polygon {
	...
	//if the first concrete class does not override all abstract methods declared in a parent abstract class their will be a compile error
...
class Rectangle extends Polygon {
	...
	void sayHello()  { System.out.println("Rect"); }
}
class Square extends Rectangle {
	...
	void sayHello()  { System.out.println("Square"); }
}