...
class Sandwich {
	...
	Sandwich(String bread) { this.bread = bread; }
	Sandwich() { this.bread = "White"; }
}
...
class CompareBread<T extends Sandwich> implements Comparator<T> {
	...
	//a good way to remember this is that compare takes two objects, but String uses compareTo and already implements it.
