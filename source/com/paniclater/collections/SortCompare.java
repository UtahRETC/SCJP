...
public class SortCompare {
	public static void main(String[] args) {
		...
		//it will print out the negative index of where the element should be minus one if it doesn't find it
		...
		//this one is screwy because the comparator sorts by length and several strings have equal lengths. 
		...
		//if you try to binary search the array without the proper comparator it won't be able to find the element, 
