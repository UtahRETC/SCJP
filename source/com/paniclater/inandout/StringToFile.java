...
public class StringToFile {
	public static void main(String[] args) {
		//Be careful when constructing a string to use as a path for a file that you use File.separator not File.pathSeparator
		//File.separator is the character used to separate directories in a path to a file -- / in unix linux land, \ in windows 
		//File.pathSeparator is the character used to separate lists of paths (the only case I'm familiar with would be in setting up the
